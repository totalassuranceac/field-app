...
export const HOWTO_GUIDES: HowToGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Open a person to add a new charge, a one-off payment (Payroll / Spiff / Other), or set an optional default weekly amount for the report.",
    ],
    tips: [
      "Balances are calculated (charges − payments). History is permanent.",
      "Recording weekly deductions is separate from the owner report — the report shows what to take; Save this week's deductions logs what was actually taken.",
