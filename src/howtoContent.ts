...
export const HOWTO_GUIDES: HowToGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "When you file the claim (email form for ACES — never the portal), tap Claim submitted → moves to Hold.",
      "Hold = waiting credit — do not scrap. Return to vendor moves it to Return.",
      "Johnstone and Solar Supply drop-offs land on Return (not File).",
      "Solar: when they have the failed part and delete the invoice, tap “Solar received return — invoice deleted” (Approved $0). Never scrap Solar.",
    ...
    tips: [
      "Submitted is not done. Credit is money closeout. Do not scrap on Claim submitted.",
  ...
  },
  {
    ...
    steps: [
      ...
      "ACES / Goodman-style: email the warranty form — never file in a vendor portal from this app.",
      "Hold: claim submitted, waiting for credit — do not scrap.",
      "Return: Johnstone, Solar Supply, or vendor said send it back — never scrap; never file online.",
      "Solar Supply: they give the replacement free; when Solar receives the failed part they delete the invoice ($0 closeout).",
      "Parked: new-purchase / do-not-file — off the File badge until Unpark.",
