...
export const HOWTO_GUIDES: HowToGuide[] = [
  ...
  // ——— Who can do what ———
  {
    ...
    path: "/howto",
    steps: [
      "Field: fuel, weekly checks, warranty drop-off, request repair, truck gear, parts receipts, live map Map/Call.",
      "Warehouse: inventory, scan-to-receive, issue-to-tech + truck scan, pickup log, bottles, warranties process.",
      "Mechanic: shop repairs, oil/service, yard walk, fleet flags, vehicles, weekly check board.",
      "Office: live map Map/Call, scheduled repairs, people, inventory overview, warranties, reports.",
