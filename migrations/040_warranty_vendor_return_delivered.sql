-- Warranty vendor-return path stays open until credit decision:
-- dropped_off → claim_submitted → return_to_vendor → delivered → approved | rejected
-- Open statuses: dropped_off, claim_submitted, return_to_vendor, delivered
-- Closed only: approved, rejected
